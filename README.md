...
Problems done in various programming languages.
...
TODO mike@carif.io: someday there will be a python3 snap. Prefer that when it happens.
...
```
htpasswd -b .config/project.py/build/resources/pypiserver/htpasswd.txt ${USER} problems
```
...
redirect_to_fallback = True
                root = ['/home/mcarifio/src/mcarifio/problems/.config/project.py/build/resources/pypiserver/packages']
              server = auto
           verbosity = 2
        welcome_file = None
